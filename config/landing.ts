...
export const heroLanding: HeroSectionConfig = {
  headerText: "Create a Stunning Portfolio from LinkedIn",
  headerTextColor: "in Minutes",
  subHeaderText:
    ...
    list: [
      {
        title: "Type Safety",
        description:
          "Ensure your code is robust and error-free from the start.",
        icon: "shield_check",
      },
      {
        title: "Production Ready",
        description:
          "Launch with confidence knowing your app is ready for prime time.",
        icon: "rocket",
      },
      {
        title: "Scalable",
...
export const features: FeaturesList = {
  ...
  subtitle:
    "Discover how our key features can simplify your development process and enhance your project's functionality.",
